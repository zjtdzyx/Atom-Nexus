          ...
          properties: {
            ...
            didDocument: { 
              ...
              properties: {
                ...
                id: 'did:email:1234567890abcdef',
                controller: 'did:email:1234567890abcdef',
                verificationMethod: [{
                  id: 'did:email:1234567890abcdef#keys-1',
                  type: 'Ed25519VerificationKey2020',
                  controller: 'did:email:1234567890abcdef',
                  publicKeyHex: '6a7280fec3467e73b0de36357d5707790d58b8a718e7f3f549a4ae5fce0e1e8c'
                }],
                authentication: ['did:email:1234567890abcdef#keys-1']
              }
            }
          }
        },
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        ...
        error: { type: 'string', example: 'DID创建失败: 必须提供钱包地址、邮箱或社交账号中的至少一种' }
      }
    }
  })
